/**
 * Template: Pago Confirmado por Transferencia Bancaria
 * Trigger: admin approve, transaction.status = confirmed, order.payment_status = paid
 */

interface BankTransferConfirmedParams {
  customerName: string;
  orderId: string;
  productName: string;
  productBrand: string;
...
export function generateBankTransferConfirmedHTML(params: BankTransferConfirmedParams): string {
...
<body>
  <div class="container">
    ...
    <div class="card">
      ...
      <p style="margin-top: 24px;"><strong>📌 Próximo paso:</strong></p>
      <p>Tu pago fue verificado. Prepararemos tu envío una vez que confirmes tu dirección.</p>
      
      <a href="${params.trackingUrl}" class="button">Confirmar Dirección de Envío</a>
