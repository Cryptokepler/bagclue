    ...
    <nav className={`transition-all duration-300 bg-white border-b border-gray-100 relative`}>
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link href="/account/login" className="font-[family-name:var(--font-inter)] text-sm tracking-[0.16em] uppercase text-gray-600 hover:text-[#E85A9A] transition-colors outline-none focus-visible:ring-1 focus-visible:ring-[#E85A9A] focus-visible:ring-offset-2 focus-visible:ring-offset-white">
            Iniciar sesión
          </Link>
          <Link href="/account/login" className="bg-[#E85A9A] text-white px-6 py-2.5 rounded-full font-[family-name:var(--font-inter)] text-sm tracking-[0.12em] uppercase font-semibold hover:bg-[#EC5C9F] transition-colors outline-none focus-visible:ring-2 focus-visible:ring-[#E85A9A] focus-visible:ring-offset-2 focus-visible:ring-offset-white">
            Regístrate
          </Link>
          <CartIcon />
        </div>
        ...
        <div className="md:hidden bg-white/98 backdrop-blur-md border-t border-gray-100 animate-fade-in">
          <div className="px-6 py-6 flex flex-col gap-4">
            ...
            <div className="pt-2 mt-2 border-t border-gray-200 space-y-3">
              <Link href="/account/login" onClick={() => setMobileOpen(false)} className="font-[family-name:var(--font-inter)] block text-sm tracking-[0.16em] uppercase text-gray-600 hover:text-[#E85A9A] transition-colors py-2 outline-none focus-visible:ring-1 focus-visible:ring-[#E85A9A] focus-visible:ring-offset-2 focus-visible:ring-offset-white">
                Iniciar sesión
              </Link>

              <Link href="/account/login" onClick={() => setMobileOpen(false)} className="font-[family-name:var(--font-inter)] inline-flex items-center justify-center w-full gap-2 bg-[#E85A9A] text-white px-6 py-3 text-sm tracking-wide uppercase font-semibold hover:bg-[#EC5C9F] transition-colors rounded-full outline-none focus-visible:ring-2 focus-visible:ring-[#E85A9A] focus-visible:ring-offset-2 focus-visible:ring-offset-white">
                Regístrate
              </Link>
            </div>

            <a href="https://ig.me/m/salebybagcluemx" target="_blank" rel="noopener noreferrer" className="font-[family-name:var(--font-inter)] mt-2 inline-flex items-center justify-center gap-2 border border-[#E85A9A] text-[#E85A9A] px-6 py-3 text-sm tracking-wide uppercase font-medium hover:bg-[#E85A9A] hover:text-white transition-colors rounded-full">
