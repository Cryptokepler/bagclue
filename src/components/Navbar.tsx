    ...
    <nav className={`transition-all duration-300 bg-white border-b border-gray-100 relative`}>
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-10">
          ...
          <Link href="/account" className="font-[family-name:var(--font-inter)] text-sm tracking-[0.16em] uppercase text-gray-600 hover:text-[#E85A9A] transition-colors">
            Mi cuenta
          </Link>
          <CartIcon />
        </div>
      ...
      {mobileOpen && (
        <div className="md:hidden bg-white/98 backdrop-blur-md border-t border-gray-100 animate-fade-in">
          <div className="px-6 py-6 flex flex-col gap-4">
            <Link href="/catalogo" onClick={() => setMobileOpen(false)} className="font-[family-name:var(--font-inter)] text-sm tracking-[0.16em] uppercase text-gray-600 hover:text-[#E85A9A] transition-colors py-2">
              Catálogo
            </Link>
            ...
            <Link href="/catalogo" onClick={() => setMobileOpen(false)} className="font-[family-name:var(--font-inter)] text-sm tracking-[0.16em] uppercase text-gray-600 hover:text-[#E85A9A] transition-colors py-2 flex items-center gap-2">
              Recién llegadas
            ...
            <Link href="/apartado" onClick={() => setMobileOpen(false)} className="font-[family-name:var(--font-inter)] text-sm tracking-[0.16em] uppercase text-gray-600 hover:text-[#E85A9A] transition-colors py-2">
              Apartado
            </Link>

            <Link href="/#autenticidad" onClick={() => setMobileOpen(false)} className="font-[family-name:var(--font-inter)] text-sm tracking-[0.16em] uppercase text-gray-600 hover:text-[#E85A9A] transition-colors py-2">
              Autenticidad
            </Link>

            <Link href="/nosotros" onClick={() => setMobileOpen(false)} className="font-[family-name:var(--font-inter)] text-sm tracking-[0.16em] uppercase text-gray-600 hover:text-[#E85A9A] transition-colors py-2">
              Nosotros
            </Link>

            <Link href="/contacto" onClick={() => setMobileOpen(false)} className="font-[family-name:var(--font-inter)] text-sm tracking-[0.16em] uppercase text-gray-600 hover:text-[#E85A9A] transition-colors py-2">
              Contacto
            </Link>

            <Link href="/account" onClick={() => setMobileOpen(false)} className="font-[family-name:var(--font-inter)] text-sm tracking-[0.16em] uppercase text-gray-600 hover:text-[#E85A9A] transition-colors py-2">
              Mi cuenta
            </Link>
