    ...
    <div className="pt-28 pb-24">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="space-y-8 text-[#F5F0EB]/60 leading-relaxed mb-20">
          <p className="text-lg">
            <span className="text-[#E91E8C] font-[family-name:var(--font-playfair)]">BAGCLUE</span> nació en 2019 con una visión clara: hacer accesible el lujo auténtico desde México. Lo que comenzó como una pasión por las piezas de diseñador se convirtió en un referente de confianza en el mercado de lujo preloved.
          </p>
          <p>
          ...
          <p>
            Nuestro servicio <span className="text-[#E91E8C]">París 2U</span> nos permite traer piezas directamente desde boutiques en Francia, garantizando acceso a colecciones exclusivas que no siempre están disponibles en México.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-20">
          {[
            ...
            <div key={s.label} className="text-center border border-[#E91E8C]/10 p-6">
              <span className="font-[family-name:var(--font-playfair)] text-3xl text-[#E91E8C]">{s.number}</span>
