    ...
    <div className="pt-28 pb-24">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="text-center mb-20">
          <span className="text-xs tracking-[0.5em] uppercase text-[#FF69B4]/60">Plan de pagos</span>
          <h1 className="font-[family-name:var(--font-playfair)] text-4xl md:text-5xl text-gray-900 mt-3">Apartado</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
          {[
            ...
            <div key={s.step} className="border border-[#FF69B4]/10 p-8 hover:border-[#FF69B4]/30 transition-all duration-500">
        ...
        {/* Benefits */}
        <div className="bg-[#111] border border-[#FF69B4]/10 p-10 mb-20">
          <h2 className="font-[family-name:var(--font-playfair)] text-2xl text-gray-900 mb-8 text-center">Beneficios</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={b.title} className="text-center">
                ...
                <h3 className="font-[family-name:var(--font-playfair)] text-lg text-gray-900 mt-4 mb-2">{b.title}</h3>
                <p className="text-sm text-gray-900/50">{b.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="text-center">
          <p className="text-gray-900/50 mb-6">¿Te interesa apartar una pieza? Escríbenos para conocer los detalles.</p>
