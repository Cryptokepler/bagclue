  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-[#E85A9A]/10 via-[#E85A9A]/5 to-white" />

        <div className="relative z-10 text-center px-6 animate-fade-in-up max-w-3xl mx-auto">
          <span className="text-xs tracking-[0.5em] uppercase text-[#E85A9A]/70 mb-4 block">SALEBYBAGCLUE MX</span>
          <h1 className="font-[family-name:var(--font-playfair)] text-5xl md:text-7xl tracking-[0.15em] text-gray-900 mb-6">
            Descubre el lujo <span className="text-[#E85A9A]">auténtico</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="https://ig.me/m/salebybagcluemx" target="_blank" rel="noopener noreferrer" 
               className="inline-flex items-center gap-3 bg-[#E85A9A] text-white px-8 py-4 text-sm tracking-widest uppercase font-medium hover:bg-[#EC5C9F] transition-all duration-300 rounded-full shadow-lg shadow-[#E85A9A]/30">
            ...
            <Link href="/catalogo" className="text-sm tracking-widest uppercase text-[#E85A9A] border border-[#E85A9A]/40 px-8 py-4 hover:bg-[#E85A9A]/5 transition-all duration-300 rounded-full">
              Ver catálogo
            </Link>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-14">
          <span className="text-xs tracking-[0.5em] uppercase text-[#E85A9A]/60">Nuestra promesa</span>
          <h2 className="font-[family-name:var(--font-playfair)] text-3xl md:text-4xl text-gray-900 mt-3">¿Por qué elegir BAGCLUE?</h2>
          <div className="w-16 h-px bg-[#E85A9A]/40 mx-auto mt-6" />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={f.title} className="text-center bg-[#E85A9A]/5 rounded-2xl p-8 border border-[#E85A9A]/10">
      ...
      {/* Featured products */}
      <section className="max-w-7xl mx-auto px-6 py-20 border-t border-[#E85A9A]/10">
        <div className="text-center mb-14">
          <span className="text-xs tracking-[0.5em] uppercase text-[#E85A9A]/60">Catálogo</span>
        ...
        {featured.length > 0 ? (
          <>
            ...
            <div className="text-center mt-12">
              <Link href="/catalogo" className="inline-flex items-center gap-2 bg-[#E85A9A] text-white px-8 py-3 text-sm tracking-widest uppercase font-medium hover:bg-[#EC5C9F] transition-all duration-300 rounded-full">
          ...
          <div className="text-center py-16">
            <div className="max-w-md mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="https://ig.me/m/salebybagcluemx" target="_blank" rel="noopener noreferrer" 
                   className="text-sm tracking-widest uppercase text-[#E85A9A] border border-[#E85A9A]/40 px-8 py-3 hover:bg-[#E85A9A]/5 transition-all duration-300 rounded-full">
                  Contáctanos
                </a>
              </div>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 border-t border-[#E85A9A]/10">
        <div className="text-center mb-14">
          <span className="text-xs tracking-[0.5em] uppercase text-[#E85A9A]/60">Comunidad</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div key={t.name} className="bg-white rounded-2xl p-8 border border-[#E85A9A]/10 shadow-sm">
              <p className="text-sm text-gray-600 leading-relaxed mb-4 italic">&ldquo;{t.text}&rdquo;</p>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-[#E85A9A]/10 flex items-center justify-center text-[#E85A9A] font-bold text-sm">{t.name[0]}</div>
                <div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-20 border-t border-[#E85A9A]/10">
        <div className="text-center mb-14">
          <span className="text-xs tracking-[0.5em] uppercase text-[#E85A9A]/60">Simple y seguro</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={s.step} className="text-center bg-gradient-to-b from-[#E85A9A]/5 to-white rounded-2xl p-8 border border-[#E85A9A]/10">
              <span className="text-4xl block mb-3">{s.icon}</span>
              <span className="text-xs font-bold text-[#E85A9A] tracking-widest">PASO {s.step}</span>
        ...
        <div className="text-center mt-10">
          ...
          <Link href="/apartado" className="text-sm tracking-widest uppercase text-[#E85A9A] border border-[#E85A9A]/40 px-6 py-2.5 hover:bg-[#E85A9A]/5 transition-all duration-300 rounded-full">
      ...
      {/* CTA final + Instagram */}
      <section className="bg-gradient-to-b from-[#E85A9A]/5 to-[#E85A9A]/10 py-20">
