    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 animate-fade-in-up">
          <div className="mb-6">
            <span className="text-xs tracking-[0.5em] uppercase text-[#E91E8C]/60">SALEBYBAGCLUE MX</span>
          </div>
          <h1 className="font-[family-name:var(--font-playfair)] text-5xl md:text-7xl lg:text-8xl tracking-[0.2em] text-[#E91E8C] mb-6">
            BAGCLUE
          </h1>
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
          <svg className="w-5 h-5 text-[#E91E8C]/30" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M19 14l-7 7m0 0l-7-7m7 7V3" /></svg>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <div className="text-center mb-16">
          <span className="text-xs tracking-[0.5em] uppercase text-[#E91E8C]/60">Selección</span>
        ...
        <div className="text-center mt-12">
          <Link href="/catalogo" className="text-sm tracking-widest uppercase text-[#E91E8C] border border-[#E91E8C]/30 px-8 py-3 hover:bg-[#E91E8C] hover:text-[#0A0A0A] transition-all duration-300">
      ...
      {/* Categories */}
      <section className="max-w-7xl mx-auto px-6 py-24 border-t border-[#E91E8C]/10">
        <div className="text-center mb-16">
          <span className="text-xs tracking-[0.5em] uppercase text-[#E91E8C]/60">Categorías</span>
          <h2 className="font-[family-name:var(--font-playfair)] text-3xl md:text-4xl text-[#F5F0EB] mt-3">Explora</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            { title: 'Bolsas', desc: 'Chanel, Hermès, Goyard y más', href: '/catalogo', gradient: 'from-[#1a1a1a] to-[#E91E8C]/20' },
            ...
            <Link key={c.title} href={c.href} className="group relative overflow-hidden border border-[#E91E8C]/10 hover:border-[#E91E8C]/30 transition-all duration-500">
              <div className={`bg-gradient-to-br ${c.gradient} p-12 text-center`}>
                ...
                <span className="inline-block mt-6 text-xs tracking-widest uppercase text-[#E91E8C] group-hover:translate-x-2 transition-transform duration-300">Explorar →</span>
              </div>
            </Link>
          ))}
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24 border-t border-[#E91E8C]/10">
        <div className="text-center mb-16">
          <span className="text-xs tracking-[0.5em] uppercase text-[#E91E8C]/60">Proceso</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {[
            ...
            <div key={s.step} className="text-center">
              <span className="font-[family-name:var(--font-playfair)] text-5xl text-[#E91E8C]/20">{s.step}</span>
      ...
      {/* About teaser */}
      <section className="max-w-4xl mx-auto px-6 py-24 text-center border-t border-[#E91E8C]/10">
        <span className="text-xs tracking-[0.5em] uppercase text-[#E91E8C]/60">Nuestra historia</span>
        ...
        <Link href="/nosotros" className="text-sm tracking-widest uppercase text-[#E91E8C] border border-[#E91E8C]/30 px-8 py-3 hover:bg-[#E91E8C] hover:text-[#0A0A0A] transition-all duration-300">
          Conoce más
        </Link>
      </section>

      {/* Instagram */}
      <section className="max-w-7xl mx-auto px-6 py-24 text-center border-t border-[#E91E8C]/10">
        <span className="text-xs tracking-[0.5em] uppercase text-[#E91E8C]/60">Síguenos</span>
        ...
        <a href="https://instagram.com/salebybagcluemx" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm tracking-widest uppercase text-[#E91E8C] hover:text-[#F5F0EB] transition-colors">
