...
async function createProduct() {
  console.log('🚀 Creando producto Chanel Vanity Slim Beige...\n')
  
  // 1. Generate slug
  const slug = await generateUniqueSlug({
    brand: 'Chanel',
    title: 'Vanity Slim Beige',
    model: 'Vanity Slim',
    color: 'Beige'
  })
  ...
  const productData = {
    slug,
    title: 'Chanel Vanity Slim Beige',
    brand: 'Chanel',
    model: 'Vanity Slim',
    color: 'Beige',
    ...
    price: 83000,
    currency: 'MXN',
    description: 'Chanel Vanity Slim en piel caviar color beige, una pieza compacta y elegante con acolchado clásico, cierre superior con doble zipper, asa superior y cadena metálica entrelazada en piel. Su formato tipo vanity la hace ideal para elevar looks de día o noche con un toque femenino y atemporal.',
  ...
  // 3. Upload image
  const imagePath = '/home/node/.openclaw/media/inbound/file_917---7db64e8c-9043-408c-a029-f3a6a7a7a99d.jpg'
